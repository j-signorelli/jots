...
class OutputManager
{
    ...
    protected:
    public:
        OutputManager(const int in_rank, mfem::ParFiniteElementSpace* fespace, const int fe_order, const double in_rho, const double in_Cp, const double in_rank, const mfem::Vector& in_T_ref, const ConductivityModel* in_cond_model);
